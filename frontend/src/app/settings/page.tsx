...
export default function Settings() {
  ...
  useEffect(() => {
    ...
    const handleToggleSavePreview = (e: React.ChangeEvent<HTMLInputElement>) => {
                            ...
                            <div className="space-y-3 mt-6 pt-6 border-t border-border">
                                <label className="flex items-center gap-3 cursor-pointer">
                                    <input
                                        ...
                                        onChange={handleToggleSavePreview}
                                        className="w-5 h-5 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                                    />
                                    <span className="text-sm font-bold text-foreground">Show certificate preview automatically after saving</span>
                                </label>
                                <p className="text-xs text-muted-foreground font-medium pl-8">
                                    Disable this to enter multiple records back-to-back without closing the popup each time.
                                </p>
                            </div>

                            <button onClick={saveSettings} disabled={loading} className="bg-blue-600 text-white font-bold px-8 py-3 rounded-lg flex items-center gap-2 mt-6 hover:bg-blue-700 transition-all shadow-md w-max">
