...
import { Database, Users, AlertTriangle, ArchiveX, Activity, Calendar, Globe, MapPin, Settings2, Loader2, FileText, CheckCircle2, X, XCircle, Printer, Download } from "lucide-react";
        ...
        const fetchStats = async () => {
            try {
                ...
                if (res.ok) {
                    ...
                    // Prevent needless component re-renders if stats are identical
